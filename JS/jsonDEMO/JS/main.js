...
for (let i of data.results.forecast)
{
  console.log(i.day, i.date, "has a high of", i.high, "and a low of", i.low, "and will be", i.text);
}
...
{
  console.log(i.firstName, i.lastName, myJSON.people[counter].job);
  counter++;
}